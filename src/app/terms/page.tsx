...
export default function TermsOfService() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-7xl min-h-[80vh]">
      <h1 className="text-4xl font-bold tracking-tight mb-8 text-black dark:text-white transition-colors">Terms of Service</h1>
      <div className="prose prose-gray dark:prose-invert max-w-none text-gray-600 dark:text-zinc-400 transition-colors">
        ...
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4 transition-colors">1. Acceptance of Terms</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4 transition-colors">2. License & Usage</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4 transition-colors">3. Intellectual Property</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4 transition-colors">4. Limitation of Liability</h2>
        <p className="mb-4">
