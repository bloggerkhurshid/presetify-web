...
export default function PrivacyPolicy() {
  return (
    <div className="container mx-auto px-4 py-16 max-w-7xl min-h-[80vh]">
      <h1 className="text-4xl font-bold tracking-tight mb-8 text-black dark:text-white transition-colors">Privacy Policy</h1>
      <div className="prose prose-gray dark:prose-invert max-w-none text-gray-600 dark:text-zinc-400 transition-colors">
        <p className="mb-4">Last updated: {new Date().toLocaleDateString()}</p>
        
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4 transition-colors">1. Information We Collect</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4 transition-colors">2. How We Use Your Information</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4 transition-colors">3. Third-Party Services</h2>
        <p className="mb-4">
        ...
        <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mt-8 mb-4 transition-colors">4. Contact Us</h2>
        <p className="mb-4">
